...
class CreateScheduleTemplateScreen extends StatefulWidget {
  final Project project;
  final License? license;
  const CreateScheduleTemplateScreen(
      {required this.project, this.license, super.key});

  @override
  State<CreateScheduleTemplateScreen> createState() =>
      _CreateScheduleTemplateScreenState();
}

class _CreateScheduleTemplateScreenState
    extends State<CreateScheduleTemplateScreen> {
  ...
  ScheduleTargetType _selectedTargetType = ScheduleTargetType.user;
  ...
  Future<void> _saveTemplate() async {
    ...
    try {
      final ownerId = _userService.uid;
      if (ownerId == null || ownerId.isEmpty) {
        throw Exception('Brak ID użytkownika.');
      }

      await scheduleTemplateService.createTemplate(
      ...
      if (mounted) {
        await showSuccessDialog(context, 'Sukces',
            'Nowy szablon harmonogramu został pomyślnie utworzony.');
        context.pop(true);
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 4.0,
        title: const Text('Nowy szablon harmonogramu'),
        actions: [
          IconButton(
            icon: const Icon(Icons.save),
            tooltip: 'Zapisz szablon',
              ...
              children: [
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'np. Zmiana poranna, Praca weekendowa',
...
// ZMIANA: Dialog został znacznie uproszczony, nie zarządza już obszarami
